...
% make4ht
% - remove documentclass, remove comment hack
% - korrigieren des bib filename; bibtex laufen lassen
% - .cfg file with (actually used) macro defs
% - $ make4ht -c costoya.cfg costoya.tex  "mathjax"
